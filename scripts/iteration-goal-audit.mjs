...
const REQUIRED_DOCS = [
  ...
  },
  {
    ...
    markers: ["### Slice 34", "### Slice 39", "### Slice 44", "### Slice 45", "### Slice 46", "### Slice 47", "### Slice 48", "### Slice 49", "### Slice 50", "### Slice 51", "### Slice 52", "### Slice 53", "### Slice 54", "Release lane v1.4.3-hotfix8"],
  },
  {
